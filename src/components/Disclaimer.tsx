...
<p>Te Wāhi Auaha Makerspace ('Te Wāhi,' 'we,' 'our,' and/or 'us') values the privacy of individuals who use our websites and facilities (collectively, our 'Services'). This privacy policy (the 'Privacy Policy') explains how we collect, use, and share information from users of our Services ('Users'). By using our Services, you understand and agree to the collection, use, disclosure, and procedures this Privacy Policy describes.</p>

<h4>Your privacy matters</h4>

<p>At Te Wāhi, we care about your privacy and believe that ownership, privacy and control don’t need to be sacrificed in exchange for usability, accessibility and reliability. That’s why we limit our collection and use of your personally identifiable information (“PII”) to what’s necessary to provide our Services to you, unless you give us your consent.</p>

<h4>Information we collect</h4>

<p>We may collect a variety of information from or about you or your devices from various sources, as described below. We collect information: 1) when you provide it to us or give us permission to collect it; and 2) automatically, when you interact with the Services.</p>

<p>1. Maker Request Information. <br />
    When you request a to create a project at Te Wāhi, you voluntarily provide us with certain information, such as your name, student ID and email. You may also provide us with your project files associated with what you are building.</p>

<p>2. Communications. <br />
    If you contact us directly, we may receive additional information about you. For example, when you chat with us via email, we may receive your student ID, the contents of a message or attachments that you may send to us, and other information you choose to provide.</p>
...
We use analytics services such as Google Analytics to collect and process certain analytics data. These services may also collect information regarding your use of other websites, apps, and online resources. You can learn about Google's practices by going to <a href="https://www.google.com/policies/privacy/partners/">this site</a>, and opt out of them by downloading the Google Analytics opt-out browser add-on, available <a href="https://tools.google.com/dlpage/gaoptout">here</a>.<br /><br />
...
<p>The Services may contain links to other websites, products, or services that Te Wāhi does not own or operate. We are not responsible for the privacy practices of these third parties. We encourage you to read their privacy policies before providing any information to them.</p>
